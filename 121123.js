    ...
    // state to welcome a person. Note that name will be an 
    // array consisting of one or more values that should be 
    // joined together with one space between each, and the length 
